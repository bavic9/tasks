...
function DeleteModal({ type, title, onDeleteBtnClick, setIsDeleteModalOpen}) {
  return (
    ...
    className='fixed right-0 bottom-0 left-0 top-0 px-2 py-2 overflow-scroll scrollbar-hide z-50 flex justify-center items-center bg-[#00000080]'>
      
      {/* Delete Modal */}

      <div className='scrollbar-hide overflow-y-scroll max-w-md max-h-[95vw] my-auto bg-white dark:bg-[#2b2c37] text-black dark:text-white w-full px-8 py-8 rounded-xl'>
